...
import { ContagemEstimulosFluxoGame } from "../ContagemEstimulosFluxoGame";
...
export function ContagemEstimulosFluxoMobileGame(props: Props) {
  // Aqui pode-se adicionar hooks ou wrappers específicos para mobile (ex: scroll, feedback tátil, etc)
  return <ContagemEstimulosFluxoGame {...props} />;
}
