...
import { ChatVigilanciaErrosGame } from "../ChatVigilanciaErrosGame";
...
export function ChatVigilanciaErrosMobileGame(props: Props) {
  // Aqui pode-se adicionar hooks ou wrappers específicos para mobile (ex: scroll, feedback tátil, etc)
  return <ChatVigilanciaErrosGame {...props} />;
}
