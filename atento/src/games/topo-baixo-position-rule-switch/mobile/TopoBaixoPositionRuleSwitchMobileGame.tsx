...
import { TopoBaixoPositionRuleSwitchGame } from "../TopoBaixoPositionRuleSwitchGame";
...
export function TopoBaixoPositionRuleSwitchMobileGame(props: Props) {
  // Aqui pode-se adicionar hooks ou wrappers específicos para mobile (ex: scroll, feedback tátil, etc)
  return <TopoBaixoPositionRuleSwitchGame {...props} />;
}
