...
import { LabirintosProlongadosGame } from "../LabirintosProlongadosGame";
...
export function LabirintosProlongadosMobileGame(props: Props) {
  // Aqui pode-se adicionar hooks ou wrappers específicos para mobile (ex: scroll, feedback tátil, etc)
  return <LabirintosProlongadosGame {...props} />;
}
