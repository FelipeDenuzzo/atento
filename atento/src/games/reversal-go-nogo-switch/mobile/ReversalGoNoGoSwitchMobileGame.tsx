...
import { ReversalGoNoGoSwitchGame } from "../ReversalGoNoGoSwitchGame";
...
export function ReversalGoNoGoSwitchMobileGame(props: Props) {
  // Aqui pode-se adicionar hooks ou wrappers específicos para mobile (ex: scroll, feedback tátil, etc)
  return <ReversalGoNoGoSwitchGame {...props} />;
}
