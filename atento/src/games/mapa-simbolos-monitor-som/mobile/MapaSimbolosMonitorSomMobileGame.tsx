...
import { MapaSimbolosMonitorSomGame } from "../MapaSimbolosMonitorSomGame";
...
export function MapaSimbolosMonitorSomMobileGame(props: Props) {
  // Aqui pode-se adicionar hooks ou wrappers específicos para mobile (ex: scroll, feedback tátil, etc)
  return <MapaSimbolosMonitorSomGame {...props} />;
}
