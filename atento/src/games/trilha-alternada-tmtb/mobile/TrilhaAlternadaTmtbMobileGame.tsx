...
export function TrilhaAlternadaTmtbMobileGame({ basePoints, reportContext, onComplete }: Props) {
  ...
  return (
    <div className="space-y-5 select-none">
      ...
      {phase === "running" && (
        <div className="space-y-4 rounded-lg border border-black/10 bg-white p-5">
          <div className="relative h-[72svh] touch-manipulation rounded-xl border border-zinc-300 bg-white">
