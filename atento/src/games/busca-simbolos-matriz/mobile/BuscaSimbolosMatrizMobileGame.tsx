...
import { BuscaSimbolosMatrizGame } from "../BuscaSimbolosMatrizGame";
...
export function BuscaSimbolosMatrizMobileGame(props: Props) {
  // Aqui pode-se adicionar hooks ou wrappers específicos para mobile (ex: scroll, feedback tátil, etc)
  return <BuscaSimbolosMatrizGame {...props} />;
}
